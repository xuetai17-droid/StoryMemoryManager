...
- Critical identity/investigation knowledge is retained across ordinary fact-window pruning.
- Existing timeline knowledge is promoted locally with zero API calls.
